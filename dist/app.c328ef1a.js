...
},{"./Observer.js":"node_modules/gsap/Observer.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
function initialBlur() {
  ...
  // Apply CSS filter property to blur the "projects" section
  _gsap.gsap.set(projectsSection, {
    filter: "blur(10px)" // Blur effect with 10px radius
  });
  ...
  _ScrollTrigger.ScrollTrigger.create({
    trigger: projectsSection,
    start: "top center",
    // Start animation when the top of the "projects" section reaches the center of the viewport
    onEnter: function onEnter() {
      _gsap.gsap.to(projectsSection, {
        filter: "none",
  ...
  _ScrollTrigger.ScrollTrigger.create({
    trigger: aboutSection,
    start: "top top",
    // Start the animation when the top of the "about" section reaches the top of the viewport
    end: "bottom top",
    // End the animation when the bottom of the "about" section reaches the top of the viewport
    scrub: true,
    // Smoothly transition the opacity as the user scrolls
    ease: "power4.inOut",
  ...
  _gsap.gsap.fromTo(aboutSection, {
    opacity: 0
  },
  // Initial state: opacity set to 0
  {
    opacity: 1,
    duration: 1.5,
    ease: "power4.inOut"
  } // Final state: opacity animated to 1
  );
}

// Call the initialBlur function when the document is loaded
document.addEventListener("DOMContentLoaded", initialBlur);
},{"gsap":"node_modules/gsap/index.js","gsap/ScrollTrigger":"node_modules/gsap/ScrollTrigger.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
