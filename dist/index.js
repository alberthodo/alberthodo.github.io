...
function initialBlur() {
    ...
    const aboutSection = document.querySelector("#about");
    // Apply CSS filter property to blur the "projects" section
    (0, _gsap.gsap).set(projectsSection, {
        filter: "blur(10px)"
    });
    // Animate away the blur effect when user scrolls down
    (0, _scrollTrigger.ScrollTrigger).create({
        ...
        start: "top center",
        onEnter: ()=>{
            (0, _gsap.gsap).to(projectsSection, {
                filter: "none",
                duration: 1,
                ease: "power4.inOut"
            });
    ...
    (0, _scrollTrigger.ScrollTrigger).create({
        ...
        ease: "power4.inOut",
        onUpdate: (self)=>{
            if (self.direction === -1) // Check if scrolling direction is up
            // Reapply the initial blur effect when scrolling back up
            (0, _gsap.gsap).to(projectsSection, {
                filter: "blur(10px)",
                duration: 1,
    ...
    (0, _gsap.gsap).fromTo(aboutSection, {
        opacity: 0
    }, {
        opacity: 1,
        duration: 1.5,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequirefad5")
